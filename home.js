...
const canWeDeliverTwo = (zip) => {
    const zips = deliveryAreaZipCodes.filter(zipCode => zipCode === zip)
    console.log(zips)
    if(zips.length > 0) {
...
// console.log(canWeDeliverTwo(75157))

const canWeDeliver3 = (zip) => {
    const yesOrNo = deliveryAreaZipCodes.includes(zip)
    if(yesOrNo === true){
...
// console.log(canWeDeliver3(85205))
